...
/**
 * Creating 4 fields that are not instantiated in the constructor The statistics
 * are hardcoded in each weapon The getters will return all the values of each
 * weapon, a the code does not need to be duplicated
 * 
 * @author Andrew
 *
 */
