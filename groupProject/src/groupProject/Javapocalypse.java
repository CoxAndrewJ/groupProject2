...
public class Javapocalypse implements ActionListener
{
	...
	// the following2 methods are used to dispose of the frame and instantiate the
	// gameboard
	...
	/**
	 * All code in the GameBoardMain method will run only once we have hit the ready
	 * button. Otherwise, code would run instantaneously
	 */
